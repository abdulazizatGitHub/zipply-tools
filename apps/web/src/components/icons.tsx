/**
 * Inline SVG icons — stroke-based, 24×24 grid, 1.5px stroke weight.
 * All icons accept a `className` prop for sizing and colour via Tailwind.
 */
...
export function IconFilePdf({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function IconMerge({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function IconScissors({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function IconGripVertical({ className = 'h-4 w-4' }: IconProps) {
  return (
...
export function IconImageResize({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <path d="M8 21h12a2 2 0 0 0 2-2V9" />
...
export function IconSquare({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function IconSquareRounded({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function IconFlower({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <path d="M22 12a3 3 0 0 1-3 3 3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3z" />
      <path d="M8 12a3 3 0 0 1-3 3 3 3 0 0 1-3-3 3 3 0 0 1 3-3 3 3 0 0 1 3 3z" />
    </svg>
  );
}

export function IconHexagon({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
