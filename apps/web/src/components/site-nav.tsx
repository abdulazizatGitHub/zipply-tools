...
/**
 * Canonical site nav — wordmark + direct links to the three live tools. Used identically on
 * home and all three tool pages (see DECISIONS.md / Phase C: one nav, no duplicates). Active-tool
 * wayfinding is derived from the current route via usePathname(), so it highlights naturally on a
 * tool page and shows nothing extra on home. No auth controls.
 */
